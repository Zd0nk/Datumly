...
def run_rolling_plan(players_base, boot, fixtures, cs_map, my_team_df,
    ...
    for gw_offset in range(horizon_gws):
        ...
        for t in transfers:
            current_itb = current_itb + t["OUT_price"] - t["IN_price"]
...
def main():
    ...
    progress.progress(0.80, text="Understat loaded.")
    ...
    show_cols = ["web_name","team_short","position","price","form","ep_next",
